...
- Generate between 2 and 4 insight cards based on real observations, then always add one final GOAL TRAJECTORY card as the last card (3–5 cards total)
- Never give more than one thing to do per card
- Each card must include a "cta" field — a 2-word button label the user taps to read the full insight. Make it feel curious or personal. Every card must have a DIFFERENT cta — no two cards can share the same label. Draw from a wide range: "Find out", "Tell me", "See why", "Dig in", "Show me", "Worth knowing", "Unpack it", "Go deeper", "Makes sense", "Interesting", "Say more", "Explain it", "I'm listening", "Good to know", "Walk me through". Be creative — don't just pick the first few examples. Never use "Learn more".
